...
public class Loger_Demo {
    ...
    @BeforeMethod
    public void initLoggers(Method m) throws Exception {
    	
    	String Filename =".\\logs\\" + m.getName() + ".txt";
	...
	public void createUser() throws Exception {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath(emailXpath)).sendKeys("test786@tst786.com");
